...
namespace Market.API.Identity
{
    public static class Config
    {
        ...
        private static IdentityResource BuildProfileResource()
        {
            ...
            profile.UserClaims.Add("position");
            return profile;
        }
        ...
        public static IEnumerable<ApiScope> ApiScopes =>
            ...
            {
                JwtClaimTypes.Role, JwtClaimTypes.Email, "restaurant_id", "tenant_id", "display_name", "tenant_name", "position"
            })
            };
        ...
        public static IEnumerable<ApiResource> ApiResources =>
            ...
            {
                Scopes = { "biteflow.api" },
                UserClaims = { JwtClaimTypes.Role, JwtClaimTypes.Email, "restaurant_id", "tenant_id", "display_name", "tenant_name", "position" }
            }
            };
